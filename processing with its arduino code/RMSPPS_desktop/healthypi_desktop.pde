...
//   
//   THE SOFTWARE IS PROVIDED "AS IS", WITHOUT WARRANTY OF ANY KIN8888D, EXPRESS OR IMPLIED, INCLUDING BUT 
...
public void setup() 
{
  ...
  GPointsArray pointsResp = new GPointsArray(1000);
  ...
  plotECG.setPos(0,(totalPlotsHeight/3)-130);
  plotECG.setDim(width-250, (totalPlotsHeight/3)-10);
  plotECG.setBgColor(0);
  plotECG.setBoxBgColor(120);
  plotECG.setLineColor(color(0, 255, 0));
  plotECG.setLineWidth(3);
  plotECG.setMar(0,0,0,0);
  
  plotPPG = new GPlot(this);
  plotPPG.setPos(0,(totalPlotsHeight/3)+100);
  plotPPG.setDim(width-250, (totalPlotsHeight/3)-10);
  ...
  plotResp.setPos(0,(totalPlotsHeight/3)+(totalPlotsHeight/3)+100);
  plotResp.setDim(width-250, (totalPlotsHeight/3)-10);
  plotResp.setBgColor(0);
  plotResp.setBoxBgColor(0);
  plotResp.setLineColor(color(0,191,255));
...
public void draw() 
{
 ...
 // plotPPG  .drawBox();
  ...
  stroke(color(0, 4, 117));
  strokeWeight(3);

  line(970, 0,970, height-40);
  line(width-310, 600, width, 600);
   line(width-310, 240, width, 240);
    line(width-310, 420, width, 420);
  //line(width-240, (height/3)+160, width,( height/3)+180);
 // line(width-240, (height/3)+340, width,( height/3)+340);
 // line(width-3000, (height/3)+30, width, (height/3)+30);
 // line(width-3000, (height/3)-(height/3), width, (height/3)-(height/3));
  ...
  case CESState_PktLen_Found:
    ...
    } else  //All  and data received
    {
      ...
      {     
        ...
        resp_avg[arrayIndex1]= (float)resp;
        resAvg =  averageValue(resp_avg);
        resp = (resp_avg[arrayIndex1] - resAvg);
        ...
        {  
          ...
          if (startPlot)
          {
          // BP.setText("BP:"+BP_Value_Sys+"/"+BP_Value_Dia );
              SP02.setText(BP_Value_Sys +"");
            Temp.setText(Temp_Value+"");
            rpm.setText(BP_Value_Dia +"");
          }
        }     
        if (arrayIndex1 == 1000)
        {  
...
{  
  ...
  bpm1.setFont(new Font("Arial", Font.PLAIN, 70));
    HR.setLocalColor(2, color(0, 255, 0));
  bpm.setFont(new Font("Arial", Font.PLAIN, 19));
  bpm.setLocalColor(2, color(0, 255, 0));
  HR.setFont(new Font("Arial", Font.PLAIN, 30));
  titel.setLocalColor(2,color(255, 255, 255));
  titel.setFont(new Font("Arial", Font.PLAIN, 30));
  titel2.setLocalColor(2,color(255, 255, 255));
  titel2.setFont(new Font("Arial", Font.PLAIN, 10));
  //BP.setLocalColor(2, color(255, 0, 0));
  //BP.setFont(new Font("Arial", Font.PLAIN, 30));
  Temp.setLocalColorScheme(color(255,0,0));
  Temp.setFont(new Font("Arial", Font.PLAIN, 70));
  temprature.setLocalColorScheme(color(255,0,0));
  temprature.setFont(new Font("Arial", Font.PLAIN, 30));
  tempraturep.setLocalColorScheme(color(255,0,0));
  tempraturep.setFont(new Font("Arial", Font.PLAIN, 19));
  SP02.setLocalColor(2, color(255, 255, 0));
  SP02.setFont(new Font("Arial", Font.PLAIN, 70));
   oxgen_sat.setLocalColor(2, color(255, 255, 0));
  oxgen_sat.setFont(new Font("Arial", Font.PLAIN, 30));
     oxgen_satp.setLocalColor(2, color(255, 255, 0));
  oxgen_satp.setFont(new Font("Arial", Font.PLAIN, 19));
  rpm.setLocalColor(2, color(0, 191, 255));
 // rpm.setText("0");
  rpm.setFont(new Font("Arial", Font.PLAIN, 70));
    rpm2.setLocalColor(2, color(0, 191, 255));
 
  rpm2.setFont(new Font("Arial", Font.PLAIN, 19));
   RES.setLocalColor(2, color(0, 191, 255));
